  ...
  override def mapRecord(record: Node, generatedAt: Long): Object  = {
    ...
    BidLadderTotalSourceRecord.struct(
      BidLadderTotalSourceRecord(
        ...
        TennetHelper.NodeSeqToDouble(record \ "RAMPDOWN_60_"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPDOWN_15_60"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPDOWN_0_15"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPUP_0_15"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPUP_15_60"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPUP_60_240"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPUP_240_480"),
        TennetHelper.NodeSeqToDouble(record \ "RAMPUP_480_"),
        generatedAt,
